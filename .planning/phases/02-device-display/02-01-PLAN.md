...
**7. Update MeasurementInfoDialogController** to handle device data:
...
```bash
grep -c "loadDeviceAttributes\|findDeviceKit\|fetchDevices\|formatTimestampDE" "/Users/jiridockal/development/ECO-TB/js library/ECO Project Wizard.js"
```
Expected: At least 4 matches (one for each function definition)
  </verify>
  <done>
